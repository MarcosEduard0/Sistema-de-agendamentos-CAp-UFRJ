...
echo iconbar(array(
	array('rooms/add', 'Nova Sala', 'add.png'),
));
...
<table width="100%" cellpadding="2" cellspacing="2" border="0" class="zebra-table sort-table" id="jsst-rooms" up-data='<?= json_encode($sort_cols) ?>'>
	...
	<thead>
		<tr class="heading">
			...
			<td class="h" title="Localização">Localização</td>
			<td class="h" title="Professor">Professor</td>
	...
	<tbody>
		...
		<?php $i++;
			...
			echo '<td colspan="5" align="center" style="padding:16px 0">Não existe salas!</td>';
		}
		?>
	</tbody>
</table>