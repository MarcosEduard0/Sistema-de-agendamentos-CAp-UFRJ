...
$iconbar = iconbar(array(
	array('holidays/add', 'Novo Feriado', 'add.png'),
	array('holidays/update', 'Atualizar Ano', 'refresh.png'),
));
...
<table width="100%" cellpadding="2" cellspacing="2" border="0" class="sort-table" id="jsst-holidays">
	...
	<tr class="heading">
		...
		<td class="h" title="Início">Data de início</td>
		<td class="h" title="Fim">Data final</td>
