...
$sort_cols = ["Tipo", "Habilitado", "Usuário", "Nome", "Último Acesso", "Ações"];
...
<div id="users_list">
	...
	<table width="100%" cellpadding="2" cellspacing="2" border="0" class="zebra-table sort-table" up-data='<?= json_encode($sort_cols) ?>'>
		...
		<thead>
			<tr class="heading">
				<td width="7%" class="h" title="Tipo">Tipo</td>
				<td width="8%" class="h" title="Habilitado">Habilitado</td>
				<td width="20%" class="h" title="Usuário">Usuário</td>
				<td width="20%" class="h" title="Nome">Nome</td>
				<td width="20%" class="h" title="ÚltimoAcesso">Último Acesso</td>
