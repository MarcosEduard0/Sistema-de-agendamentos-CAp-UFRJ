...
class UpdateAgent extends BaseAgent
{
	...
	private function process_edit_booking()
	{
		...
		if ($update) {
			...
			$msgs = [
				self::EDIT_ONE => 'O agendamento foi atualizado com sucesso.',
				self::EDIT_FUTURE => 'O agendamento e todos os agendamentos futuros da sequência foram atualizadas.',
				self::EDIT_ALL => 'Todos os agendamentos da sequência foram atualizadas com sucesso.',
			];
